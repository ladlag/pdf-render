...
import com.mercury.report.model.ReportData;
import com.mercury.report.model.ReportDataBuilder;
import com.mercury.report.model.Section;
...
public class ChineseFontConfigurationDemo {
    ...
    private static void demonstrateWithoutFontConfig(ReportData data) throws IOException {
        ...
        System.out.println("  service.setUseHtmlPipeline(true);");
